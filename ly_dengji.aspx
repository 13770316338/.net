<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ly_dengji.aspx.cs" Inherits="ly_dengji" %>
        ...
        <div>
            ...
            <div class="as-textbox">
                <div class="jumbotron">
                    ...
                    <div class="input-group input-group-lg textbox-size left center">
                        <span class="input-group-addon" id="sizing-addon5">性别</span>
                        <asp:TextBox ID="TextBox4" runat="server" CssClass="form-control" placeholder="sex"></asp:TextBox>
                    </div>
             
                    <div class="input-group input-group-lg textbox-size left center">
                        <span class="input-group-addon" id="sizing-addon7">猫详细信息</span>
                        <asp:TextBox ID="TextBox5" runat="server" CssClass="form-control" placeholder="Contact information"></asp:TextBox>
                    </div>
                    <div class="input-group input-group-lg textbox-size left center">
                        <span class="input-group-addon" id="sizing-addon8">领养要求</span>
                        <asp:TextBox ID="TextBox6" runat="server" CssClass="form-control" placeholder="requirement"></asp:TextBox>
                    </div>
