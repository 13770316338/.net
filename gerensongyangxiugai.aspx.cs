...
public partial class  gerensongyangxiugai : System.Web.UI.Page
{
    String SqlStr;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlStr = "update 猫信息表 set user_yh='" + Session["User"] + "',name='" + TextBox1.Text.Trim() + "'"
          + ",age='" + TextBox2.Text.Trim() + "',sex='" +
          TextBox3.Text.Trim() + "',describe='" + TextBox4.Text.Trim() + "'"
          + ",requirement='" + TextBox5.Text.Trim() + "', img='" +image_path + "' where cat_number= '" + Session["id"] + "'";
    ...
    public void datalistbind()
    {
        ...
        SqlStr = "select * from 猫信息表 where user_yh='" + Session["User"] + "'";
        DS = db.GetDataSetBySql(SqlStr);
        {
            ...
            this.TextBox4.Text = DS.Tables[0].Rows[0][5].ToString();
    ...
    {
        SqlStr = string.Format("delete from 猫信息表 where cat_number='{0}'", Session["id"]);
        if (db.UpDataBySql(SqlStr))
        {
